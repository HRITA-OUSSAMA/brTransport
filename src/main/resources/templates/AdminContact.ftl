            ...
            <span class="number">${n}</span>
              ...
              <div class="dropdown-menu">
                <div class="dropmenu-content">
                  <#if contacts1??>
                   <#list contacts1 as contact1>
                  <li>
                    ${contact1.getNom()}_${contact1.getPrenom()}
                    <div class="text">${contact1.getSujet()}</div>
                  </li>
                </#list>
                </#if>
                </div>
        ...
        <div class="table ">
          <div class="table-body">
           ...
           <#list contacts as contact>
            <div class="table-row">
              <div>${contact.getNom()}</div>
              <div class="avatar">${contact.getPrenom()}</div>
              <div>${contact.getEmail()}</div>
              <div class="">
                <span class="">${contact.getSujet()}</span>
              </div>
